...
def analysis_ui(acc_white,acc_black,count_type_white,count_type_black):
    ...
    while True:
        ...
        create_text_center(SCREEN_ANALYSIS,f'{count_type_white[0]}               Best Moves               {count_type_black[0]}',(300,200),LIME)
        ...
        create_text_center(SCREEN_ANALYSIS,
                           ...
                           (300, 300), LIGHT_GREEN)
        create_text_center(SCREEN_ANALYSIS,f'{count_type_white[3]}               Inaccuracy               {count_type_black[3]}',(300,350),LIGHT_YELLOW)
        create_text_center(SCREEN_ANALYSIS,
